export const years = [
  {
    ...
    days: [
      ...
      },
      {
        ...
        answers: {part1: {testInput: 102, puzzleInput: 1065}, part2: {testInput: 94, puzzleInput: 1249}}
      },
      {
    ...
    days: [
      {
        ...
        answers: {part1: {testInput: 24000, puzzleInput: 75501}, part2: {testInput: 45000, puzzleInput: 215594}}
      },
      {
        name: "Day 2: Rock Paper Scissors", path: "./2022/02", taskUrl: "https://adventofcode.com/2022/day/2",
        answers: {part1: {testInput: 15, puzzleInput: 15691}, part2: {testInput: 12, puzzleInput: 12989}}
      },
      {
        name: "Day 3: Rucksack Reorganization", path: "./2022/03", taskUrl: "https://adventofcode.com/2022/day/3",
        answers: {part1: {testInput: 157, puzzleInput: 7691}, part2: {testInput: 70, puzzleInput: 2508}}
      },
      {
        name: "Day 4: Camp Cleanup", path: "./2022/04", taskUrl: "https://adventofcode.com/2022/day/4",
        answers: {part1: {testInput: 2, puzzleInput: 513}, part2: {testInput: 4, puzzleInput: 878}}
      },
      {
        name: "Day 5: Supply Stacks", path: "./2022/05", taskUrl: "https://adventofcode.com/2022/day/5",
        answers: {part1: {testInput: "CMZ", puzzleInput: "VPCDMSLWJ"}, part2: {testInput: "MCD", puzzleInput: "TPWCGNCCG"}}
      },
      {
        name: "Day 6: Tuning Trouble", path: "./2022/06", taskUrl: "https://adventofcode.com/2022/day/6",
        answers: {part1: {testInput: 7, puzzleInput: 1361}, part2: {testInput: 19, puzzleInput: 3263}}
      },
      {
        name: "Day 7: No Space Left On Device", path: "./2022/07", taskUrl: "https://adventofcode.com/2022/day/7",
        answers: {part1: {testInput: 95437, puzzleInput: 1232307}, part2: {testInput: 24933642, puzzleInput: 7268994}}
      },
      {
        name: "Day 8: Treetop Tree House", path: "./2022/08", taskUrl: "https://adventofcode.com/2022/day/8",
        answers: {part1: {testInput: 21, puzzleInput: 1840}, part2: {testInput: 8, puzzleInput: 405769}}
      },
      {
        name: "Day 9: Rope Bridge", path: "./2022/09", taskUrl: "https://adventofcode.com/2022/day/9",
        answers: {part1: {testInput: 13, puzzleInput: 6376}, part2: {testInput: 1, puzzleInput: 2607}}
      },
      {
        name: "Day 10: Cathode-Ray Tube", path: "./2022/10", taskUrl: "https://adventofcode.com/2022/day/10",
        answers: {part1: {testInput: 13140, puzzleInput: 14860}, part2: {
          testInput:   "\n##..##..##..##..##..##..##..##..##..##..\n###...###...###...###...###...###...###.\n####....####....####....####....####....\n#####.....#####.....#####.....#####.....\n######......######......######......####\n#######.......#######.......#######.....\n",
          puzzleInput: "\n###...##..####.####.#..#.#..#.###..#..#.\n#..#.#..#....#.#....#..#.#..#.#..#.#.#..\n#..#.#......#..###..####.#..#.#..#.##...\n###..#.##..#...#....#..#.#..#.###..#.#..\n#.#..#..#.#....#....#..#.#..#.#.#..#.#..\n#..#..###.####.####.#..#..##..#..#.#..#.\n"}}
      },
      {
        name: "Day 11: Monkey in the Middle", path: "./2022/11", taskUrl: "https://adventofcode.com/2022/day/11",
        answers: {part1: {testInput: 10605, puzzleInput: 50616}, part2: {testInput: 2713310158, puzzleInput: 11309046332}}
      },
      {
        name: "Day 12: Hill Climbing Algorithm", path: "./2022/12", taskUrl: "https://adventofcode.com/2022/day/12",
        answers: {part1: {testInput: 31, puzzleInput: 383}, part2: {testInput: 29, puzzleInput: 377}}
      },
      {
      ...
      },
      {
        ...
        answers: {part1: {testInput: 3068, puzzleInput: 3069}, part2: {testInput: 1514285714288, puzzleInput: 1523167155404}}
      },
      {
